...
import { getPosts,getPost,getPostsByTitle } from "./02 - getPosts";
...
export {
  createPost,getPosts,
  updatePost,changeAuthorPost,deletePost,createPostWithCategories,updatePostInfo,getPost,getPostsByTitle,insertCategoriesInPost
}